...
const _excluded$K = ["children", "closeAfterTransition", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "manager", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
const _excluded$w = ["alt", "children", "className", "component", "imgProps", "sizes", "src", "srcSet", "variant"];
...
const _excluded$8 = ["autoWidth", "children", "classes", "className", "defaultOpen", "displayEmpty", "IconComponent", "id", "input", "inputProps", "label", "labelId", "MenuProps", "multiple", "native", "onClose", "onOpen", "open", "renderValue", "SelectDisplayProps", "variant"];
...
const FormControlLabel = /*#__PURE__*/React.forwardRef(function FormControlLabel(inProps, ref) {
  ...
  return /*#__PURE__*/jsxs(FormControlLabelRoot, _extends({
    ...
    children: [/*#__PURE__*/React.cloneElement(control, controlProps), label, required && /*#__PURE__*/jsxs(AsteriskComponent, {
      ownerState: ownerState,
      "aria-hidden": true,
      className: classes.asterisk,
      children: ["\u2009", '*']
...
function signin(urlApi, handleError, onSuccess, setToken, username, password, remember) {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _a = fetch;
                    _b = urlApi + "/signin.php?";
                    _c = URLSearchParams.bind;
                    _d = {
                        username: username
                    };
                    return [4 /*yield*/, sha512(password)];
                case 1: return [4 /*yield*/, _a.apply(void 0, [_b + new (_c.apply(URLSearchParams, [void 0, (_d.password = _e.sent(),
                                _d)]))()])
...
function useLocalStorage(name) {
    var _a = useState(getValue(name)), value = _a[0], setValue = _a[1];
    var save = function (userToken, remember) {
...
function DenanuSignin(props) {
    var backendLocation = props.backendLocation, onLogIn = props.onLogIn, theme = props.theme, signupUrl = props.signupUrl;
    var _a = React.useState(false), unameError = _a[0], setUnameError = _a[1];
    var _b = React.useState(false), pswrdError = _b[0], setPswrdError = _b[1];
    var _c = React.useState(undefined), unameErrorMsg = _c[0], setUnameErrorMsg = _c[1];
    var _d = useToken(), setToken = _d[1];
    var handleSubmit = function (event) {
        var _a, _b, _c;
        event.preventDefault();
        var data = new FormData(event.currentTarget);
        var uname = (_a = data.get("user-name")) === null || _a === void 0 ? void 0 : _a.toString();
        var pswrd = (_b = data.get("password")) === null || _b === void 0 ? void 0 : _b.toString();
        var memo = (_c = data.get("remember")) === null || _c === void 0 ? void 0 : _c.valueOf();
        setUnameError(uname === "");
        setPswrdError(pswrd === "");
        signin(backendLocation, function (reason) {
            ...
            if (onLogIn)
                onLogIn();
        }, setToken, uname, pswrd, memo);
    };
    return (React.createElement(ThemeProvider, { theme: theme },
        React.createElement(Container$1, { component: "main", maxWidth: "xs" },
            React.createElement(Box$1, { sx: {
                ...
                React.createElement(Avatar$1, { sx: { m: 1, bgcolor: 'secondary.main' } },
                    React.createElement(default_1$1, null)),
                React.createElement(Typography$1, { component: "h1", variant: "h5" }, "Sign in"),
                React.createElement(Box$1, { component: "form", onSubmit: handleSubmit, noValidate: true, sx: { mt: 1 } },
                    React.createElement(TextField$1, { margin: "normal", required: true, fullWidth: true, id: "user-name", label: "User Name", name: "user-name", autoComplete: "user-name", autoFocus: true, error: unameError || Boolean(unameErrorMsg), helperText: unameErrorMsg }),
                    React.createElement(TextField$1, { margin: "normal", required: true, fullWidth: true, name: "password", label: "Password", type: "password", id: "password", autoComplete: "current-password", error: pswrdError }),
                    React.createElement(FormControlLabel$1, { control: React.createElement(Checkbox$1, { value: true, color: "primary" }), label: "Remember me", name: "remember" }),
                    React.createElement(Button$1, { type: "submit", fullWidth: true, variant: "contained", sx: { mt: 3, mb: 2 } }, "Sign In"),
                    React.createElement(Grid$1, { container: true },
                        React.createElement(Grid$1, { item: true, xs: true },
                            React.createElement(Link$1, { href: "#", variant: "body2" }, "Forgot password?")),
                        React.createElement(Grid$1, { item: true },
                            React.createElement(Link$1, { href: signupUrl, variant: "body2" }, "Don't have an account? Sign Up"))))))));
}

function booleanToString(val) {
    return val ? "true" : "false";
}
function signup(urlApi, handleError, onSuccess, username, email, password, remember, sendmail) {
    return __awaiter(this, void 0, void 0, function () {
        var data, _a, _b, _c;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    if (!(username && email && password)) return [3 /*break*/, 3];
                    _a = fetch;
                    _b = urlApi + "/signup.php?";
                    _c = URLSearchParams.bind;
                    _d = {
                        username: username,
                        mail: email,
                    ...
                    return [4 /*yield*/, sha512(password)];
                case 1: return [4 /*yield*/, _a.apply(void 0, [_b + new (_c.apply(URLSearchParams, [void 0, (_d.password = _e.sent(),
                                _d.sendmail = booleanToString(sendmail),
                                _d)]))()])
                        .then(function (r) { return r.json(); })];
                case 2:
                    data = _e.sent();
...
var default_1 = Email.default = void 0;
var _createSvgIcon = _interopRequireDefault(requireCreateSvgIcon());
var _jsxRuntime = require$$2;
var _default = (0, _createSvgIcon.default)( /*#__PURE__*/(0, _jsxRuntime.jsx)("path", {
  d: "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"
}), 'Email');
default_1 = Email.default = _default;

function SignUp(props) {
    var emailUpdates = props.emailUpdates, backendLocation = props.backendLocation, theme = props.theme, loginUrl = props.loginUrl;
    var _a = React.useState(false), unameError = _a[0], setUnameError = _a[1];
    var _b = React.useState(false), emailError = _b[0], setEmailError = _b[1];
    var _c = React.useState(false), pswrdError = _c[0], setPswrdError = _c[1];
    var _d = React.useState(false), awaitAuthentication = _d[0], setAwaitAuthentication = _d[1];
    var _e = React.useState(undefined), unameErrorMsg = _e[0], setUnameErrorMsg = _e[1];
    var handleSubmit = function (event) {
        var _a, _b, _c, _d, _e;
        event.preventDefault();
        var data = new FormData(event.currentTarget);
        var uname = (_a = data.get("user-name")) === null || _a === void 0 ? void 0 : _a.toString();
        var email = (_b = data.get("email")) === null || _b === void 0 ? void 0 : _b.toString();
        var pswrd = (_c = data.get("password")) === null || _c === void 0 ? void 0 : _c.toString();
        var memo = (_d = data.get("remember")) === null || _d === void 0 ? void 0 : _d.valueOf();
        var sendmail = (_e = data.get("receiveEmails")) === null || _e === void 0 ? void 0 : _e.toString();
        setUnameErrorMsg(undefined);
        signup(backendLocation, function (reason) {
    ...
    if (awaitAuthentication) {
        return (React.createElement(ThemeProvider, { theme: theme },
            React.createElement(Container$1, { maxWidth: "xs" },
                React.createElement(Box$1, { sx: baseBoxSx },
                    React.createElement(Avatar$1, { sx: { m: 1, bgcolor: 'secondary.main' } },
                        React.createElement(default_1, null)),
                    React.createElement(Typography$1, { component: "h1", variant: "h5" }, "E-Mail verification"),
    ...
    return (React.createElement(ThemeProvider, { theme: theme },
        React.createElement(Container$1, { maxWidth: "xs" },
            React.createElement(Box$1, { sx: baseBoxSx },
                React.createElement(Avatar$1, { sx: { m: 1, bgcolor: 'secondary.main' } },
                    React.createElement(default_1$1, null)),
                React.createElement(Typography$1, { component: "h1", variant: "h5" }, "Sign up"),
                React.createElement(Box$1, { component: "form", noValidate: true, onSubmit: handleSubmit, sx: { mt: 3 } },
                    React.createElement(Grid$1, { container: true, spacing: 2 },
                        React.createElement(Grid$1, { item: true, xs: 12 },
                            React.createElement(TextField$1, { required: true, fullWidth: true, id: "user-name", label: "User Name", name: "user-name", autoComplete: "user-name", error: unameError || Boolean(unameErrorMsg), helperText: unameErrorMsg })),
                        React.createElement(Grid$1, { item: true, xs: 12 },
                            React.createElement(TextField$1, { required: true, fullWidth: true, id: "email", label: "Email Address", name: "email", autoComplete: "email", error: emailError })),
                        React.createElement(Grid$1, { item: true, xs: 12 },
                            React.createElement(TextField$1, { required: true, fullWidth: true, name: "password", label: "Password", type: "password", id: "password", autoComplete: "new-password", error: pswrdError })),
                        React.createElement(Grid$1, { item: true, xs: 12 },
                            React.createElement(FormControlLabel$1, { control: React.createElement(Checkbox$1, { value: true, color: "primary" }), label: "Remember me", name: "remember" })),
                        emailUpdates ?
                            React.createElement(Grid$1, { item: true, xs: 12 },
                                React.createElement(FormControlLabel$1, { control: React.createElement(Checkbox$1, { value: true, color: "primary" }), label: "I want to receive inspiration, marketing promotions and updates via email.", name: "receiveEmails" }))
                            :
                                null),
                    React.createElement(Button$1, { type: "submit", fullWidth: true, variant: "contained", sx: { mt: 3, mb: 2 } }, "Sign Up"),
                    React.createElement(Grid$1, { container: true, justifyContent: "flex-end" },
                        React.createElement(Grid$1, { item: true },
                            React.createElement(Link$1, { href: loginUrl, variant: "body2" }, "Already have an account? Sign in"))))))));
}

function registerFunc(urlApi, handleError, onSuccess, setToken, username, mail, password, sendmail, remember, signature) {
    return __awaiter(this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(username && mail && password && sendmail && signature)) return [3 /*break*/, 2];
                    console.log(username);
                    return [4 /*yield*/, fetch(urlApi + "/register.php?" + new URLSearchParams({
                            username: username,
                            mail: mail,
                            password: password,
                            sendmail: sendmail,
...
function R(props) {
    var onLogIn = props.onLogIn, backendLocation = props.backendLocation;
    var _a = useToken(), setToken = _a[1];
    var params = new URLSearchParams(window.location.search);
    registerFunc(backendLocation, function (r) { }, function () {
        if (onLogIn)
            onLogIn();
...
export { DenanuSignin as DenanuLogin, R as DenanuRegister, SignUp as DenanuSignup, getValue, useLocalStorage, useToken };
